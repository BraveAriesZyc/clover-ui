...
const loaders: Record<string, () => Promise<any>> = {
    ...
    'fluent-emoji-high-contrast': () =>
        import('@iconify/json/json/fluent-emoji-high-contrast.json'),
    ...
    'streamline-freehand-color': () =>
        import('@iconify/json/json/streamline-freehand-color.json'),
    ...
    'streamline-kameleon-color': () =>
        import('@iconify/json/json/streamline-kameleon-color.json'),
    ...
    'streamline-stickies-color': () =>
        import('@iconify/json/json/streamline-stickies-color.json'),
    'streamline-ultimate-color': () =>
        import('@iconify/json/json/streamline-ultimate-color.json'),
...
watchEffect(async () => {
    ...
    try {
        ...
        if (iconSet.value && iconSet.value.icons) {
            try {
                ;(IconifyVue as any).addCollection?.(iconSet.value)
            } catch {
            }
...
<template>
    <DisplayPage title="Icon 图标" @goDocs="() => router.push('/docs/icon')">
        <div class="tools">
            ...
            <ZScrollChips v-model="colorChoice" :items="colorItems"/>
        ...
        <div v-else class="gallery">
            <div class="gallery__meta">
                ...
                <div class="pager">
                    <button class="pager__btn" @click="prevPage" :disabled="page <= 1">
                        <ZIcon name="bx:chevron-left"/>
                    </button>
                    <span class="pager__info">{{ page }} / {{ totalPages }}</span>
                    <button class="pager__btn" @click="nextPage" :disabled="page >= totalPages">
                        <ZIcon name="bx:chevron-right"/>
                    </button>
                </div>
            </div>
            ...
            <div v-else class="grid">
                ...
                >
                    <template #cell="{ item }">
                        <div class="cell" @click="copyIconName(item)">
