export const attributes = [
  { name: 'modelValue', description: '绑定值', type: 'string | number', values: '—', default: "''" },
  ...
  { name: 'type', description: '原生输入类型', type: 'string', values: 'text 等', default: 'text' },
  { name: 'maxlength', description: '最大长度', type: 'number', values: '—', default: '—' },
  { name: 'invalid', description: '非法状态样式', type: 'boolean', values: '—', default: 'false' },
...
export const types = [
  { name: 'ValueType', definition: 'string | number', usage: '输入框绑定值的类型；同时用于事件回调参数' },
  { name: 'FocusEvent', definition: 'DOM FocusEvent', usage: '原生焦点事件类型；用于 focus/blur 回调参数' },
]
